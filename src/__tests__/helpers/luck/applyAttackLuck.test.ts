...
describe('applyAttackLuck', () => {
  ...
  it('should increase normal attack damage if roll is between 15-59', () => {
    ...
    expect(result).toEqual({luckMessage: 'The attack has been increased +0', dealedDamage: 8});
  });
  ...
  it('should increase normal attack damage if roll is between 15-59', () => {
    ...
    expect(result).toEqual({luckMessage: 'The attack has been increased +3', dealedDamage: 23});
  });

...
export const insertSocketId = (email, socketId) => {
...
export const removePlayerConnected = (socket, socketId) => {
...
export const eachSideHasPlayers = (io, users) => {
    let gameHasPlayers = true;
...
export const sortPlayersByCharisma = (players) => {
